...
Dans le projet, on dépend d'interfaces (`IUserRepository`, `ISkinRepository`).  
Même si l'instanciation est encore faite avec `new` dans les constructeurs, la base du principe est déjà là.
